...
<div class="container-fluid">
	<div class="container">
		...
		<div class="hyeon__productFormTitle">
			...
			<form name="product" method="post" enctype="multipart/form-data" action="/auction/livepost" onsubmit="return check()">
				<div class="hyeon__productWrite">
					...
					<textarea  name="link" placeholder="링크 입력" style="border:1px solid #ccc; width: 200px;
