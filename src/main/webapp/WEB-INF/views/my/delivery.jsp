...
<body >
	<div class="container padding-bottom-3x mb-1">
		<div class="card mb-3">
			...
			<div class="d-flex flex-wrap flex-sm-nowrap justify-content-between py-3 px-2 bg-secondary col-lg-12" style="height:60px;">
			<br>
		...
		<div>
			<div class="card-body">
				<div class="steps d-flex flex-wrap flex-sm-nowrap justify-content-between padding-top-2x padding-bottom-1x" style="margin-top:75px;">
					<div class="steps d-flex flex-wrap flex-sm-nowrap justify-content-between padding-top-2x padding-bottom-1x"	style="display: flex;">
		...
		<div
			...
			<div class="text-left text-sm-right" style="text-align: right; margin-right:35px;">
				<a class="btn btn-outline-primary btn-rounded btn-sm" href="orderDetails" data-toggle="modal" data-target="#orderDetails" style="background:#0da9ef">View Order Details</a>
			</div>
		</div>
	</div>
</body>
