...
<%@ include file="../header.jsp" %>
  <div class="mypage__container">
      ...
      <div class="mypage__main">
        <h2 class="mypage__main__title">결제/구매내역</h2>
        <ul class="myform__main__list">
          ...
          <li>
            ...
            <a href="/my/delivery?orderState=${list.orderState }&orderNum=${list.orderNum}"  role="button" class="completeBidHistory__btn btn btn_default btn-block go-bid-btn">
	        							<span>배송상태보기</span>
	      							</a>
          </li>
          </c:forEach>
