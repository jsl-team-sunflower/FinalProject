	  ...
	  <!-- action을 처리하기전에 check()사용자 함수를 실행하고 되돌아 와라-->
			<table class="bord_table">
				...
				<tbody>
					<tr class="first">
						<th>글쓴이</th>
						<td><input type="text" name="writer" readonly value="${view.notice_writer }"></td>
					</tr>
					<tr>
						<th>제목</th>
						<td><input type="text" name="title" value="${view.notice_title }"></td>
					</tr>
					<tr>
						<th>내용</th>
						<td><textarea name="content">${view.notice_content }</textarea></td>
					</tr>
				</tbody>
			</table>
			<div class="btn_wrap">
